...
```{r}
library(readr)
breaks_base <- read_csv("C:/Users/Gustavo Reyes/Box/Share Table Project/Milk Spoilage Model Docs/Time Temp Study/Trial Data/Time Data/Breaks_quant.csv")
```
...
ggsave("histograms_lunch.jpg", width =8, height = 6, units = "in", dpi = 300)
