...
range (RTB_List_Time)
quantile(RTB_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 90, 95)/100)
...
for (i in 1:50){
  s2b1_List_total_milks<-c(s3b2_List_total_milks,length(s3b2_List[[i]]$ID))
}
...
quantile(s3b2_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 90, 95)/100)
